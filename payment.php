<html>
  ...
  <body>
    <?php
        ...
        $email_to = "militiahockey@gmail.com";
    ...
    <div>
      <form action="https://secure.authorize.net/gateway/transact.dll" method="post"> 
        ...
        <input name="x_type"  value="<?php echo $type; ?>" type="hidden">
        <input name="x_amount" value="<?php echo $amount; ?>" type="hidden">
        <input name="x_show_form" value="<?php echo $show_form; ?>" type="hidden">
        <input name="x_relay_response" value="TRUE" type="hidden">
        <input name="x_delim_data" vaue="FALSE" type="hidden">
